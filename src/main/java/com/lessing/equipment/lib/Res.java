...
//		String MaskStatus = "";
//		switch(emMaskStatus) {
//		case NetSDKLib.EM_MASK_STATE_TYPE.EM_MASK_STATE_UNKNOWN:
//			MaskStatus = bundle.getString("EM_MASK_STATE_UNKNOWN");
//			break;
//		case NetSDKLib.EM_MASK_STATE_TYPE.EM_MASK_STATE_NODISTI:
//			MaskStatus = bundle.getString("EM_MASK_STATE_NODISTI");
//			break;
//		case NetSDKLib.EM_MASK_STATE_TYPE.EM_MASK_STATE_NOMASK:
//			MaskStatus = bundle.getString("EM_MASK_STATE_NOMASK");
//			break;
//		case NetSDKLib.EM_MASK_STATE_TYPE.EM_MASK_STATE_WEAR:
