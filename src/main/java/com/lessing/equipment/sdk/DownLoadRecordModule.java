...
//		boolean bRet = PTZControlUtil.netsdk.CLIENT_QueryRecordFile(PTZControlUtil.m_hLoginHandle, nChannelId,
...
//
//        boolean bret = PTZControlUtil.netsdk.CLIENT_SetDeviceMode(PTZControlUtil.m_hLoginHandle, emType, steamType.getPointer());
//        if (!bret) {
...
//	}
//
//	public static NetSDKLib.LLong downloadRecordFile(int nChannelId,
//                                                     int nRecordFileType,
//                                                     NetSDKLib.NET_TIME stTimeStart,
//													 NetSDKLib.NET_TIME stTimeEnd,
...
//
//		m_hDownLoadHandle = PTZControlUtil.netsdk.CLIENT_DownloadByTimeEx(PTZControlUtil.m_hLoginHandle, nChannelId, nRecordFileType,
...
//			return;
//		}
//		PTZControlUtil.netsdk.CLIENT_StopDownload(m_hDownLoadHandle);
//	}
//}
